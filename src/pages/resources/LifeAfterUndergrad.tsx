          ...
          <section id="programs" className="mb-12 bg-white">
            ...
            <div className="mt-6 overflow-x-auto">
              <table className="w-full text-left border-collapse">
                ...
                <tbody>
                  {programs.map((p, i) => <tr key={i} className="border-b hover:bg-muted/30">
                      ...
                      <td className="py-3 pr-4">
                        {p.link ? <a className="text-primary underline" href={p.link} target="_blank" rel="noopener noreferrer">Visit</a> : <span className="text-muted-foreground">—</span>}
                      </td>
                    </tr>)}
                </tbody>
              </table>
