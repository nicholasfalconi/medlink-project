      ...
      <main className="section-padding">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <header className="mt-6 mb-8 text-center">
            <h1 className="text-3xl md:text-4xl font-bold text-foreground">Planning for Life after undergrad</h1>
            <p className="mt-3 text-muted-foreground max-w-2xl mx-auto">
              Applying to medical school is challenging. Here’s how to plan smartly for gap years, graduate programs, or paid work—without losing momentum.
            </p>
          </header>

          <section className="grid md:grid-cols-3 gap-6 mb-12">
            <article className="rounded-xl border bg-card p-6">
              <h2 className="text-xl font-semibold text-foreground">Graduate school</h2>
              ...
              <div className="mt-4 text-sm text-muted-foreground">
                ...
                <ul className="mt-2 list-disc pl-5 space-y-1">
                  ...
                  <li>Supervisor identified before applying?</li>
            ...
            <article className="rounded-xl border bg-card p-6">
              <h2 className="text-xl font-semibold text-foreground">Paid Work</h2>
              <p className="mt-3 text-sm text-muted-foreground">Good for building income and real-world experience.</p>
              <ul className="mt-2 list-disc pl-5 text-sm text-muted-foreground space-y-1">
                <li>Competitive market: refine resume and cover letters</li>
                <li>Expect patience and persistence</li>
              </ul>
              <div className="mt-4 text-sm text-muted-foreground">
                <p className="font-medium text-foreground">Important considerations</p>
                <ul className="mt-2 list-disc pl-5 space-y-1">
                  <li>Values: mobility, culture, work–life balance</li>
                </ul>
                <p className="font-medium text-foreground mt-3">Common employers</p>
                <ul className="mt-2 list-disc pl-5 space-y-1">
                  <li>Advocacy industry (e.g., mental health, health equity)</li>
            ...
            <article className="rounded-xl border bg-card p-6">
              <h2 className="text-xl font-semibold text-foreground">Gap Year</h2>
              <ul className="mt-3 list-disc pl-5 text-sm text-muted-foreground space-y-1">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-foreground">Curated Canadian programs</h2>
            <p className="text-sm text-muted-foreground mt-2">Note: This guide is not comprehensive; always perform your own research. *Most internships are paid.</p>
